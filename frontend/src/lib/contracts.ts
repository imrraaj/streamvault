export const CONTRACTS = {
  STETH: process.env.NEXT_PUBLIC_STETH_ADDRESS as `0x${string}`,
  VAULT: process.env.NEXT_PUBLIC_VAULT_ADDRESS as `0x${string}`,
  PAYMENT: process.env.NEXT_PUBLIC_PAYMENT_ADDRESS as `0x${string}`,
};
...
export const PAYMENT_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "bytes32", name: "songId", type: "bytes32" },
      { indexed: false, internalType: "uint256", name: "amount", type: "uint256" },
    ],
    name: "PlaySettled",
    type: "event",
...
export function formatStETH(amount: bigint): string {
  return (Number(amount) / 1e18).toFixed(6);
}

export function parseStETH(amount: string): bigint {
